...
> **ARCHIVED** — Email integration is complete. Site uses MailerLite (group `180628908682512348`).
> API key is configured in `send-card.html`. Welcome sequence is live. This guide references
> Buttondown/ConvertKit and is kept for historical reference only.
